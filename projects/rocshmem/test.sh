...
export USE_HEAP_DEVICE_FINEGRAIN=1
export USE_HEAP_DEVICE_UNCACHED=1
export USE_HEAP_DEVICE_COARSEGRAIN=1
# export GPU_DEVICE_ORDINAL="0"
LOG_DIR=./tests-results/logs-heatmap-loadstore/
mkdir -p $LOG_DIR
...
mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=1 \
 ...
 -s 1073741824 2>&1 | tee $LOG_DIR/wgput_n2_w1_z64_1073741824B.log
...
mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=2 \
 ...
 -s 1073741824 2>&1 | tee $LOG_DIR/wgput_n2_w2_z64_1073741824B.log

mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=1 \
 -x UCX_ROCM_IPC_SIGPOOL_MAX_ELEMS=16384 -x ROCSHMEM_HEAP_SIZE=68719476736 \
 -x ROCSHMEM_TEST_UUID=1 --timeout 300 --map-by numa \
 ./build/tests/functional_tests/rocshmem_functional_tests -a 26 -w 1 -z 1024 \
 -s 1073741824 2>&1 | tee $LOG_DIR/wgput_n2_w1_z1024_1073741824B.log
 
mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=2 \
 -x UCX_ROCM_IPC_SIGPOOL_MAX_ELEMS=16384 -x ROCSHMEM_HEAP_SIZE=68719476736 \
 -x ROCSHMEM_TEST_UUID=1 --timeout 300 --map-by numa \
 ./build/tests/functional_tests/rocshmem_functional_tests -a 26 -w 2 -z 1024 \
 -s 1073741824 2>&1 | tee $LOG_DIR/wgput_n2_w2_z1024_1073741824B.log
...
mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=4 \
 ...
 -s 1073741824 2>&1 | tee $LOG_DIR/wgput_n2_w4_z1024_1073741824B.log

mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=8 \
 -x UCX_ROCM_IPC_SIGPOOL_MAX_ELEMS=16384 -x ROCSHMEM_HEAP_SIZE=68719476736 \
 -x ROCSHMEM_TEST_UUID=1 --timeout 300 --map-by numa \
 ./build/tests/functional_tests/rocshmem_functional_tests -a 27 -w 8 -z 1024 \
 -s 1073741824 2>&1 | tee $LOG_DIR/wgput_n2_w8_z1024_1073741824B.log
...
mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=16 \
 ...
 -s 1073741824 2>&1 | tee $LOG_DIR/wgput_n2_w16_z1024_1073741824B.log
