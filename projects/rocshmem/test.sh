...
mpirun -n 2 -mca pml ucx -mca osc ucx -x ROCSHMEM_MAX_NUM_CONTEXTS=1 \
 ...
 -s 1073741824 2>&1 | tee ./tests-results/logs-heatmap-after/wgput_n2_w1_z1024_1073741824B.log
...
#  -s 1073741824 2>&1 | tee ./tests-results/logs-heatmap-after/wgput_n2_w16_z1024_1073741824B.log
...
#  -s 1073741824 2>&1 | tee ./tests-results/logs-heatmap-after/wgput_n2_w2_z64_1073741824B.log
