...
Usage:
    python3 aggregate_resources.py <resources_dir> <output.json>
"""
...
def main():
    if len(sys.argv) != 3:
        print(f"Usage: {sys.argv[0]} <resources_dir> <output.json>", file=sys.stderr)
        sys.exit(1)
    ...
    print(f"Aggregated {count} resource files: "
